...
urlpatterns = [
    ...
    path('modelagem/pendulo_elastico_lagrange/', views.modelagem_pendulo_elastico_lagrange, name='modelagem_pendulo_elastico_lagrange'),
    path('modelagem/pendulo_elastico_newton/', views.modelagem_pendulo_elastico_newton, name='modelagem_pendulo_elastico_newton'),
